...
(function () {
    ...
    let STATS_TRANSPARENT = { "default": true, "nền trong": "STATS_TRANSPARENTGM" };
    let STATS_OPACITY = {
        'default': 80,
        'min': 10,
        'max': 100,
...
function setupVideoSettingsBar() {
    ...
    if ($stretch.id == 'xcloud_setting_video_stretchGM') {
        ...
        dom.after(`<div id="video_stretch_x_y" style="display: ${video_stretch.default == 'setting' ? 'block' : 'fill'}">
                     <lable>Dọc
