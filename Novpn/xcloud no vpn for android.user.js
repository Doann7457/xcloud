// ==UserScript==
// @name                 XCloud no VPN VIET NAM
// @namespace            http://tampermonkey.net/
// @version              0.1
// @description          Xbox Cloud Chơi không cần VPN tại việt Nam by Nguyễn Văn Đoàn (Kênh Youtube Xbox Cloud Việt Nam)Kênh Youtube Xbox Cloud Việt Nam
// @author               Nguyễn Văn Đoàn (Kênh Youtube Xbox Cloud Việt Nam)Kênh Youtube Xbox Cloud Việt Nam
...
(function() {
    ...
    // Set your preferred language, this setting is higher than your browser's preferred language
    // Such as "ja-JP" "zh-CN" "en-US"
        ...
        switch (typeof arg0) {
            ...
            case "string":
                ...
                if (fakeip != "" ){
                    if (arg[1] ){
                        if (arg[1].headers){
                            arg[1].headers.set("X-Forwarded-For",fakeip)
                        }else{
                            let fakeipHeaders = new Headers();
                            fakeipHeaders.set("X-Forwarded-For",fakeip)
                            arg[1].headers=fakeipHeaders
                        }
                    }else{
                        arg[1]={}
                        let fakeipHeaders = new Headers();
