// ==UserScript==
// @name                 Tool Dành cho Xbox Cloud V2
// @name:zh-CN           Tool Dành cho Xbox Cloud V2
...
// @grant                unsafeWindow
// @require              https://raw.githubusercontent.com/Doann7457/7457/Master/require/jquery.min.js
// @original-script      1
...
(function() {
    ...
    //Ngôn ngữ được sử dụng theo mặc định khi ngôn ngữ thông minh báo lỗi, zh-CN đơn giản hóa, zh-TW truyền thống, công tắc chính là selectLanguage ở dòng trước
    ...
    //Công tắc chính của máy chủ mặc định là blockXcloudServer ở dòng trước
    ...
    $.ajax({
        url:"https://raw.githubusercontent.com/Doann7457/7457/Master/xbox.user.js",
        type:"GET",
        async:false,
        timeout:1000,
...
`;
    ...
    function initSettingBox() {
        ...
        dom += `<label class="" style="display: block;text-align:left;"><div   style="display: inline;">Tự bật Classic Control：</div>`;
        ...
        dom += `<label class="" style="display: block;text-align:left;"><div   style="display: inline;">Tắt kéo xuống làm mới：</div>`;
        ...
        dom += `<label class="" style="display: block;text-align:left;"><div   style="display: inline;">Xoá đen Viền 2 bên：</div>`;
        ...
        dom += `<lable>Ngang</lable><input type='text' style="outline: none;width: 102px;" id="videoX" class="videoXListener" value="${videoX}" placeholder="请输入数字"/>`
        ...
        dom+=`<div style="text-align: left;margin-top: 8px;font-size: 16px;"><lable>Hỗ Trợ Việt Hoá : Kênh Youtube:</lable><a style="margin-right:15px;outline: none;color: #ff424c;text-decoration: underline;" href="https://www.facebook.com/Doan7457">XboxCloud Việt Nam</a></a><a </div>`
