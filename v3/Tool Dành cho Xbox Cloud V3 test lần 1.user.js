...
function initSettingBox() {
    ...
    dom += `<label class="" style="display: block;text-align:left;"><div   style="display: inline;">Chế độ：</div>`;
    ...
    dom += `<label class="" style="display: block;text-align:left;"><div   style="display: inline;">Ko chạm：</div>`;
