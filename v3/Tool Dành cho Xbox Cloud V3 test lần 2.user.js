// ==UserScript==
// @name                 Tool Dành cho Xbox Cloud V3
// @name:zh-CN           Tool Dành cho Xbox Cloud V3
...
(function () {
    ...
    let STATS_POSITION = { 'default': 'top-left', 'options': { 'top-left': 'trên cùng bên trái', 'top-center': 'Trên- giữa', 'top-right': 'Trên- phải' }, 'name': 'Vị trí Thống kê' }
    ...
    static render() {
        ...
        StreamStats.#$settings = CE('div', { 'class': 'better-xcloud-stats-settings' },
                                    ...
                                    CE('div', {},
                                       CE('label', { 'for': `xcloud_setting_STATS_OPACITY` }, 'minh bạch (10-100%)'),
                                       $opacity
                                      ),
                                    CE('div', {},
...
function initSettingBox() {
    ...
    dom += `<label class="" style="display: block;text-align:left;"><div   style="display: inline;">Phím ảo Basic：</div>`;
    ...
    dom += `<label class="" style="display: block;text-align:left;"><div   style="display: inline;">Chặn Phím ảo：</div>`;
    ...
    dom += `<label class="" style="display: block;text-align:left;"><div   style="display: inline;">antiKick：</div>`;
